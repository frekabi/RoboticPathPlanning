...
Dist_Centers = [];
NDist = 5;%round((Map.Boundary(2)-Map.Boundary(1))*(Map.Boundary(4)-Map.Boundary(3)))/misinfo.R_s^2;
...
for i = 1:NDist
    ...
    [Tdist(i).Map,Tdist(i).connectivity] = RecPrmMAPConstruction_IMP(Map_new,misinfo.nprm0,misinfo.Nneig,misinfo.ThsDist,bnd);
